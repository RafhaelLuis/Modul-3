...
public class Main {
    public static void main(String[] args) {
        ...
        ListMKdiambil matkulAmbilSarjana1 = new ListMKdiambil(101, 3, "Algoritma", matkulWajib1_srj, listPresensi1, 90,
                99, 80);
        ...
        MhsSarjana mahasiswaSarjana1 = new MhsSarjana("Ndne", "Jl. Tamansari", "Bandung, 15 Desember 2005", "088888888",
                "1123017",
                "DKV", matkulSarjana);
        ...
        ListMKdiambil matkulAmbilMagister1 = new ListMKdiambil(301, 4, "Basdat", matkul1_magis, listPresensi1, 100, 80,
                70);
        ...
        MhsDoktor doktor1 = new MhsDoktor("Alfonsioso", "KBP", "Cimahi, 01 Desember 2000", "07777777", "1123009",
        ...
        Karyawan karyawan1 = new Karyawan("Jojo", "Jl. Antapani", "Jakarta, 01 Januari 2000", "0111111111", "2023008",
